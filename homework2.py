...
moscow_london = client.service.Add('Content-Length:'=moscow_london_price, FromCurrency=EUR, ToCurrency=RUB)
london_newyork = client.service.Add('Content-Length:'=london_newyork_price, FromCurrency=USD, ToCurrency=RUB)
newyork_brasilia = client.service.Add('Content-Length:'=newyork_brasilia_price, FromCurrency=BRL, ToCurrency=RUB)
brasilia_peking = client.service.Add('Content-Length:'=brasilia_peking_price, FromCurrency=CNY, ToCurrency=RUB)
peking_seoul = client.service.Add('Content-Length:'=peking_seoul_price, FromCurrency=KRW, ToCurrency=RUB)
